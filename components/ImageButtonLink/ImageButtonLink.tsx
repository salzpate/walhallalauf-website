...
function ImageButtonLink(props: Readonly<PropsWithChildren<ImageButtonLinkProps>>): JSX.Element {
  ...
  return (
    <Link href={href} className="button-link flex h-full items-center rounded-lg border border-gray-200 bg-white hover:border-gray-300 hover:bg-gray-200 hover:no-underline dark:border-gray-500 dark:bg-black dark:hover:border-gray-600 dark:hover:bg-gray-500" aria-label={`${headline}`}>
