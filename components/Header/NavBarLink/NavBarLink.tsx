...
function NavBarLink(props: Readonly<NavMenu>): JSX.Element {
  ...
  return (
    <Link
      href={href}
      className={cn(
        'relative text-sm font-thin tracking-widest text-[rgba(23,23,23,1)] uppercase transition-all duration-300 ease-in-out hover:text-secondary hover:opacity-75 dark:text-gray-300 dark:hover:text-secondary-dark',
