    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className={styles.mailtext}>
          <input ref={register} id="email" type="email" name="email" placeholder="E-Mail-Adresse eingeben" />
        </div>
        <div className={styles.formfield}>
          ...
          <input ref={register({ required: true })} className={errors.name ? styles.textinputerror : textInputClass} id="name" name="name" type="text" placeholder="Namen eingeben" />
        ...
        <div className={styles.formfield}>
          ...
          <input ref={register({ required: true })} className={errors.antwort ? styles.textinputerror : textInputClass} id="antwort" name="antwort" type="text" placeholder="E-Mail Adresse" />
        ...
        <div className={styles.formfield}>
          ...
          <textarea ref={register({ required: true })} className={errors.nachricht ? styles.textinputerror : textInputClass} id="nachricht" name="nachricht" rows={4} cols={40} placeholder="Nachricht eingeben" />
        ...
        <div className={styles.checkboxfield}>
          <label className="flex justify-start items-start">
            <div className="bg-white border-2 rounded border-gray-500 w-5 h-5 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500 dark:bg-black">
              <input ref={register({ required: true })} type="checkbox" className={styles.checkbox} id="datenschutz" name="datenschutz" />
