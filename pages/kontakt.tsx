    ...
    <Layout title={pageTitle + ' - ' + siteTitle} activeMenu="kontakt">
      ...
      <PageSection headline="Kontakt" id="kontakt">
        ...
        <div className="grid grid-cols-1 gap-6 my-6 sm:my-8 sm:grid-cols-2 lg:grid-cols-4 auto-rows-fr">
          <div>
            <ContactCard name="Ronny Krammer" position="Abteilungsleiter Ausdauer" imageSrc="/assets/images/contact-krammer.jpg" email="1.ausdauer@sv-donaustauf.de" emailHref="/lib/mailto-1aus.php" />
          </div>
          <div>
            <ContactCard name="Eduard Zimmermann" position="2. Vorstand" imageSrc="/assets/images/contact-zimmermann.jpg" email="2.ausdauer@sv-donaustauf.de" emailHref="/lib/mailto-2aus.php" />
          </div>
